#ifndef GroupMessage_h__
#define GroupMessage_h__
/*/////////////////////////////////////////////////////////////
//
// 文件名称	:	GroupMessage.h
// 创建人	: 	daviyang35@QQ.com
// 创建时间	:	2014-07-05 12:12:20
// 说明		:	组消息
/////////////////////////////////////////////////////////////*/
#pragma once
#include "Message.h"
...
public:
    ...
    void Begin()
    {
        ...
        assert ( p );
        if ( !p ) return;
        SendMessage(Singleton::GetMessageWnd(), WM_EVENT_GROUP_BEGIN, NULL, p);
    }
    ...
    void End()
    {
        ...
        assert ( p );
        if ( !p ) return;
        SendMessage(Singleton::GetMessageWnd(), WM_EVENT_GROUP_END, NULL, p);
    }
